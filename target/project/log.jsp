    ...
    <body>
		<div class="header">
			...
			<div class="login">
                ...
                <input class="button"  type="button" onclick="window.location.href='CartServlet?action=mycart'" value="购物车"/>
        ...
        <form action="LoginServlet" method="post">
            ...
            <div class="log">
				<p><%=p.Gettime()%>:用户 <%=p.Getuser()%>浏览了商品<%=p.Getname()%>,商品id为：<%=p.Getid()%> <a href="javaScript:deleteProduct('<%=p.Gettime()%>');">删除</a></p>
